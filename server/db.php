...
//=========================================================================
/**
 * Garantit qu'une valeur scalaire est en UTF-8 valide.
 * Les donnees stockees en ISO-8859-1 (via utf8_decode) sont converties.
 * Les donnees deja en UTF-8 sont retournees telles quelles.
 */
private static function toUtf8($val)
{
...
{
return self::toUtf8(self::getDbAccessor()->querySingle($sqlQuery, false));
}
//=========================================================================
...
while ($dbRow = $dbResult->fetchArray(SQLITE3_NUM))
{
$out[$dbRow[0]] = self::toUtf8($dbRow[1]);
}
return $out;
}
//=========================================================================
